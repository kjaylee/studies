...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, wallet, airdropSignature, account;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                connection = new web3.Connection(web3.clusterApiUrl('devnet'), 'confirmed');
                wallet = web3.Keypair.generate();
                return [4 /*yield*/, connection.requestAirdrop(wallet.publicKey, web3.LAMPORTS_PER_SOL)];
            case 1:
            ...
            case 2:
                //wait for airdrop confirmation
                _a.sent();
                return [4 /*yield*/, connection.getAccountInfo(wallet.publicKey)];
            case 3:
                account = _a.sent();
                console.log(account);
                return [2 /*return*/];
...
//# sourceMappingURL=get_account_info.js.map